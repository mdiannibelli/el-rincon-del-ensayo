...
<main>
  <h2 class="text-gray-500 uppercase font-light text-lg md:text-3xl text-center">Todos nuestros equipos:</h2>
  ...
  <section class="my-12">
    <div class="grid grid-cols-1 md:grid-cols-3 lg:gap-4 gap-y-8 justify-center mt-12 lg:max-w-[1400px] mx-auto">
      <?php
      include_once("../components/equipos/mostrar-equipos.php");
      ?>
    </div>
  </section>
</main>
