...
<body class="bg-neutral-950">
  ...
  <main class="my-24">
    <h1 class="text-gray-500 uppercase font-light text-lg md:text-3xl text-center mt-2 mb-4">Creá una nueva cuenta</h1>
    <?php
    include_once("../components/form/registro.php");
    ?>
  </main>
